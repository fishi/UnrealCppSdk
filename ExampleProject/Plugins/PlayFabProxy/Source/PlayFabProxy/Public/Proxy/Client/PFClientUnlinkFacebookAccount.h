...
UCLASS(MinimalAPI)
class UPFClientUnlinkFacebookAccount : public UPlayFabProxyBase
{
...
public:
    ...
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "PlayFab|Client|Account Management")
        static UPFClientUnlinkFacebookAccount* UnlinkFacebookAccount(class APlayerController* PlayerController);
