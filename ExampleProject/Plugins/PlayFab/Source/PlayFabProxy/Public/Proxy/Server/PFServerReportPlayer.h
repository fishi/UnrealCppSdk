...
public:
	...
	static UPFServerReportPlayer* ReportPlayer(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InReporterId, const FString& InReporteeId, const FString& InComment);
