...
UCLASS(MinimalAPI)
class UPFServerUpdateUserData : public UPlayFabProxyBase
{
...
public:
    ...
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "PlayFab|Server|Player Data Management")
        static UPFServerUpdateUserData* UpdateUserData(class APlayerController* PlayerController, const FBPServerUpdateUserDataRequest& InUpdateUserDataRequest);
