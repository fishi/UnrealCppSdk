...
UCLASS(MinimalAPI)
class UPFClientMatchmake : public UPlayFabProxyBase
{
...
public:
    ...
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "PlayFab|Client|Matchmaking")
        static UPFClientMatchmake* Matchmake(class APlayerController* PlayerController, const FBPClientMatchmakeRequest& InMatchmakeRequest);
...
private:
    FBPClientMatchmakeRequest Request;
