...
UCLASS(MinimalAPI)
class UPFClientGetUserPublisherReadOnlyData : public UPlayFabProxyBase
{
...
public:
    ...
    UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true"), Category = "PlayFab|Client|Player Data Management")
        static UPFClientGetUserPublisherReadOnlyData* GetUserPublisherReadOnlyData(class APlayerController* PlayerController, const FBPClientGetUserDataRequest& InGetUserDataRequest);
