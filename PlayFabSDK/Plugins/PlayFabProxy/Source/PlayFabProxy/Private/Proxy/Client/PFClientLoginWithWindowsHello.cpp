...
UPFClientLoginWithWindowsHello* UPFClientLoginWithWindowsHello::LoginWithWindowsHello(class APlayerController* PlayerController, const FBPClientLoginWithWindowsHelloRequest& InLoginWithWindowsHelloRequest)
{
    UPFClientLoginWithWindowsHello* Proxy = NewObject<UPFClientLoginWithWindowsHello>();
    Proxy->PlayerControllerWeakPtr = PlayerController;
    Proxy->Request = InLoginWithWindowsHelloRequest;
