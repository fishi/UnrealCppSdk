...
public:
	...
	static UPFAdminSetupPushNotification* SetupPushNotification(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InName, const FString& InKey, const FString& InCredential, const bool& InOverwriteOldARN);
