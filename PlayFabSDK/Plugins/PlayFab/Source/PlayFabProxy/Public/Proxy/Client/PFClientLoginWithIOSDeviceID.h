...
public:
	...
	static UPFClientLoginWithIOSDeviceID* LoginWithIOSDeviceID(UObject* WorldContextObject, class APlayerController* PlayerController, const FString& InDeviceId, const FString& InOS, const FString& InDeviceModel, const bool& InCreateAccount, const FString& InTitleId, const FString& InEncryptedRequest, const FString& InPlayerSecret, const FBPClientGetPlayerCombinedInfoRequestParams& InInfoRequestParameters);
