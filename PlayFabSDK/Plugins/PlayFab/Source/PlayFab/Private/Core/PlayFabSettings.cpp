...
namespace PlayFab
{
    const FString PlayFabSettings::sdkVersion = "0.0.171026";
    const FString PlayFabSettings::buildIdentifier = "jbuild_unrealcppsdk_2";
    const FString PlayFabSettings::versionString = "UE4SDK-0.0.171026";
